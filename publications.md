...
<div class="publication">
  ...
  <div class="summary">
    <p>Extended version presented at the undergraduate research symposium, featuring additional simulation studies comparing our model's performance with Tweedie and zero-inflated gamma alternatives under varying zero-inflation scenarios (10%-90% zeros). Includes case study applications in: (1) modeling insurance deductibles with 37% zeros, and (2) analyzing rainfall patterns in semi-arid regions with intermittent zero-rainfall days.</p>
  </div>
</div>
